...
urlpatterns = [
    ...
    url(r'^(?P<cafeId>[0-9]+)/comments/(?P<commentId>[0-9]+)/hide$', views.hide_comment, name='hide_comment'),
    url(r'^(?P<cafeId>[0-9]+)/comments/(?P<commentId>[0-9]+)/show', views.show_comment, name='show_comment'),
